    ...
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.bodyText}>
          ...
          उत्तम खेती कर रहा हूँ।{"\n"}
          मैं कुल 16 एकड़ में खेती करता हूँ।{"\n"}
          {"\n"}➤ अगर आप खीरा की खेती को वैज्ञानिक तरीके से सीखकर ज्यादा पैदावार
          और अधिक मुनाफा कमाना चाहते हैं, तो यह एडवांस PDF कोर्स आपके लिए एकदम
          सही है।
